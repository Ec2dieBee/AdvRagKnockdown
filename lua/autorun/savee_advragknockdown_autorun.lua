...
local cv_kd_pref_luacode_nexttick = CreateConVar(cvPrefix .. "preformance_luacode_nexttick", 0.01, cvTags, "[性能][代码相关] 下次统一运行控制器Tick()的时间, 这个值越大布娃娃效果越拉跨(但性能会好点我猜), 不建议大于0.03", 0)
...
hook.Add("Tick", "Savee_AdvRagKnockdown_CtrlTick", function()
    ...
    nextTick = ct + cv_kd_pref_luacode_nexttick:GetFloat()
